...
class OllamaLLM(LLMBase):
    ...
    def is_available(self) -> bool:
        ...
        try:
            ...
            model_is_pulled = self.model_name or f"{self.model_name}:latest" in [model['name'] for model in available_models] # TODO: consider removing the EXACT name check and just defaulting to latest version if not found
